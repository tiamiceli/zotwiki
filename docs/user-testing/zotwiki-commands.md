# ZotWiki Operator — Commands You Asked Me

A running record of the requests you've made in this operator session. Newest at the bottom.

| # | When | Your request |
|---|------|--------------|
| 1 | 2026-06-16 | Be the Operator for zotwiki. Populate the research library at `.../reserach_obsidian_vault/Library/`. Create a folder matching the `Test` library in Zotero, and populate the wiki. Keep a md of commands asked and a log of zotwiki runs (success/fail). |
| 2 | 2026-06-16 | "I have cleared my wiki for you to populate. please try again." |
